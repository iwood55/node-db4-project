...
const steps = [
    ...
    { step_text: 'Take out of oven after 25 minutes', step_number: 3, recipe_id: 2 },
    // Pan Seared Salmon
    { step_text: 'Heat pan', step_number: 1, recipe_id: 3 },
    { step_text: 'Cook salmon until done', step_number: 2, recipe_id: 3 },
]
